...
## Instructions to set up the Bert Chatbot Spanish Demo on Local system

1. Clone the repository in your system.
2. Download the model file from https://drive.google.com/file/d/1QPdU1-YZjG-AXpcnzQikDkCEAZa_B7ts/view?usp=sharing and unzip it in root directory.
